# -*- coding: utf-8 -*-
"""Final_Tensorflow Extractive Q&A Chatbot
...
## Project Overview
This project develops an intelligent medical question-answering system using state-of-the-art natural language processing techniques. By leveraging the power of TensorFlow and DistilBERT, we create a robust AI assistant capable of providing accurate, contextual answers to medical queries while maintaining high confidence scores and professional-grade performance metrics.

## Dataset: MedQuad Medical Q&A Collection
The MedQuad dataset serves as the foundation of our medical AI system, providing a comprehensive source of medical questions and answers specifically designed for natural language processing applications. This exceptional dataset offers:
### Dataset Characteristics:

- 43,000+ authentic patient inquiries from real-world medical scenarios
- 31 distinct question categories covering diverse medical specialties
- Multi-professional responses from doctors, nurses, pharmacists, and other healthcare experts
- Comprehensive coverage of treatments, chronic diseases, medical protocols, and preventive care
"""
...
"""## Importations of the libraries to be used"""
...
"""## Visualization of the stopword analysis"""
...
I used the distilbert trained on squad and I used the maximum length of 512 so that the chatbot will be able to generate the full answer for the question
"""
...
"""## Setting of the parameters to be used in the training of the model"""
...
*{response_dict['disclaimer']}*
    ...
    def get_analytics_display():
        ...
        try:
            ...
            if isinstance(analytics, dict):
                formatted_analytics = "Medical Model Analytics\n\n"
    ...
    with gr.Blocks(theme=gr.themes.Soft(), css=custom_css, title="TensorFlow Medical Q&A Assistant") as interface:
        ...
        gr.Markdown(
            ...
            - **Base Model**: DistilBERT (small version of BERT)
